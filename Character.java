...
public class Character {
    ...
    //ÖNEMLİ DUYURU ATTACK() METHODU KALDIRILDI: Silahla beraber olunca toplam damage almıyor çünkü.
    ...
    public void CharacterInfo(){
        ...
        System.out.println("HEALTH            : " + getCharHealth()+"/"+ (getCharLevel()*100)); // BURADA EN SONKİ CAN GÖRÜNECEK
        System.out.println("ATTACK DAMAGE     : " + getAttackPoint()); // BURADA SİLAHSIZ DAMAGE YA DA SİLAHLI HALA EMİN DEĞİLİM
